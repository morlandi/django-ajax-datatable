"""
Django settings for example_minimal project.
...
SECRET_KEY = '^!49h4^p$2iz6ezx_cdkubkmiw&cn1rqxtkvyxmcwy1l-##vk5'
...
ROOT_URLCONF = 'example_minimal.urls'
...
WSGI_APPLICATION = 'example_minimal.wsgi.application'
